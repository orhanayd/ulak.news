...
<script>
	...
	function agency(start, end){
		...
		$.ajax({
			type: 'POST',
			url: 'https://nodejs-api.ulak.news/stats/agency',
	...
	function mostCats(start, end){
		...
		$.ajax({
			type: 'POST',
			url: 'https://nodejs-api.ulak.news/stats/mostCats',
			data: JSON.stringify({ "start": start, "end": end }),
			cache: false,
			contentType: "application/json",
			dataType: 'json',
	...
	function mostNews(start, end){
		...
		$.ajax({
			type: 'POST',
			url: 'https://nodejs-api.ulak.news/stats/mostReads',
			data: JSON.stringify({ "start": start, "end": end }),
			cache: false,
			contentType: "application/json",
			dataType: 'json',
	...
	function mostWords(start, end){
		...
		$.ajax({
			type: 'POST',
			url: 'https://nodejs-api.ulak.news/stats/mostWords',
			data: JSON.stringify({ "start": start, "end": end }),
			cache: false,
			contentType: "application/json",
			dataType: 'json',
	...
	function countStats(start, end){
		...
		$.ajax({
			type: 'POST',
			url: 'https://nodejs-api.ulak.news/stats/countStats',
			data: JSON.stringify({ "start": start, "end": end }),
			cache: false,
			contentType: "application/json",
			dataType: 'json',
